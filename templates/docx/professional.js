...
function createTemplate(theme = {}) {
  ...
  const _docStyles = {
    ...
    paragraphStyles: [
      ...
      { id: "Heading4", name: "Heading 4", basedOn: "Normal", next: "Normal", quickFormat: true,
        run: { size: _SIZES.h4 || _SIZES.body, bold: true, font: _FONTS.default, color: _COLORS.text },
  ...
  function createSyntaxCodeBlock(lines) {
    const codeBorder = { style: BorderStyle.SINGLE, size: 8, color: _COLORS.codeDarkBorder };
    const darkBg = { fill: _COLORS.codeDarkBg, type: ShadingType.CLEAR };
        ...
        default: new Footer({
          children: [
            new Paragraph({
              tabStops: [{ type: TabStopType.RIGHT, position: rightTabPosition }],
              children: [
                new TextRun({ text: docInfo.company, font: _FONTS.default, size: 18, color: _COLORS.headerFooter }),
                new TextRun({ text: "\t" }),
                new TextRun({ font: _FONTS.default, size: 18, color: _COLORS.headerFooter, children: [PageNumber.CURRENT] }),
                new TextRun({ text: "/", font: _FONTS.default, size: 18, color: _COLORS.headerFooter }),
                new TextRun({ font: _FONTS.default, size: 18, color: _COLORS.headerFooter, children: [PageNumber.TOTAL_PAGES] })
              ]
            })
          ]
        })
